...
sudo scutil --set ComputerName jlibbey
sudo scutil --set HostName jlibbey
sudo scutil --set LocalHostName jlibbey
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string jlibbey
